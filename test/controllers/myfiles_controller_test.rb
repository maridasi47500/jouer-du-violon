...
class MyfilesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create myfile" do
    assert_difference("Myfile.count") do
      post myfiles_url, params: { myfile: { filename: @myfile.filename, title: @myfile.title } }
    end
  ...
  test "should update myfile" do
    patch myfile_url(@myfile), params: { myfile: { filename: @myfile.filename, title: @myfile.title } }
