...
class StuffsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stuff" do
    assert_difference("Stuff.count") do
      post stuffs_url, params: { stuff: { content: @stuff.content, memo_id: @stuff.memo_id } }
    end
  ...
  test "should update stuff" do
    patch stuff_url(@stuff), params: { stuff: { content: @stuff.content, memo_id: @stuff.memo_id } }
